        ...
        return (
            <div>
                ...
                <form className='form' onSubmit={this.FormHandler}>
                    <h2 Style="padding-left:180px;color:blue;margin-top:2px;font-style:italic;font-family:TheSpeakeasy"><u>Update Details</u>  </h2><br></br>
                    <table clasName='table'>
                        ...
                        <label id="mobileNumberlabel" class="hidden">Should be 10 digits</label>
                        <label id="mobileNumberlabel2" class="hidden">First digit Should be (6,7,8,9)</label>
                        <tr>
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <button Style="align:center;margin-bottom:13px;font-size:25px;background-color:lightgreen" type="submit" size="10px" >Update</button>
                </form>
