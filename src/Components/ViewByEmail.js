...
export function ViewByEmail() {
   ...
   const EmailHandler =async(event)=> {
     ...
     await axios.get(`http://localhost:8080/cc/email/${Email}`) 
      .then((result) => {
...
<div1>
        <br></br><br></br><br></br>
        <form className='form' onSubmit={()=>getdata({Email})}>
        <h2 Style="padding-left:180px;color:blue;margin-top:2px;font-style:italic;font-family:TheSpeakeasy"><u>Search By Email</u>  </h2><br></br>
        <table className='table'>

                        <tr>
                            <td><label>Email: </label></td>
                            <td><input type="text" Placeholder="Enter the Email" value={Email} onChange={EmailHandler} required ></input>
                            </td>
                        </tr>
            </table> 
            <br></br><br></br><br></br>
      ...
      <div2>
    <br></br><br></br><br></br>
   <h1 Style="color:green;padding-left:900px"><u>CustomerInfoByEmail</u></h1><br></br><br></br>
